			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
					...
					<main id="main" class="<?php 
						if( !get_theme_mod( 'remove-cpt-category-sidebar' )):
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
								...
								<header class="article-header">
									...
									<!--<p class="byline vcard"><?php
										//printf(__('Posted <time class="updated" datetime="%1$s">%2$s</time> by <span class="author">%3$s</span> <span class="amp">&</span> filed under %4$s.', 'bonestheme'), get_the_time('Y-m-j'), get_the_time(__('F jS, Y', 'bonestheme')), bones_get_the_author_posts_link(), get_the_term_list( get_the_ID(), 'custom_cat', "", ", ", "" ));
									?>-->
