<?php if( !get_theme_mod('disable-topbar-section') ) { ?>
	...
	<div class="top-bar cf" >
		...
		<div class="inner-top-bar wrap">
			...
			<?php if( !get_theme_mod( 'top-bar-use-widgets' )) { ?>
				...
				<?php if ( get_theme_mod( 'header_social' ) != 'none' ) { ?>
			...
			<?php } ?>
				...
				<div class="header-phone d-1of2 t-1of2 m-all last-col">
					<?php if( !get_theme_mod( 'top-bar-custom-phone-text' )) { ?>

						Call Today! <a href="tel:<?php echo get_theme_mod( 'phone-number', '888-555-1234' ); ?>" <?php if ( get_theme_mod( 'phone-number' ) ) { 
							...
							echo $ariaNumber . '"';
						} ?>><span class="header-phone-number"><?php echo get_theme_mod( 'phone-number', '888-555-1234' ); ?></span></a>

					<?php } // end if default address ?>

					<?php if( get_theme_mod( 'top-bar-custom-phone-text' )) { ?>

						<?php echo get_theme_mod( 'top-bar-custom-phone-text' ); ?>

					<?php } // end if replace default phone number content ?>						

				</div><!--header-phone--> 
			<?php } // end if use defaults ?>

			<?php if( get_theme_mod( 'top-bar-use-widgets' ) && get_theme_mod ( 'basic-or-advanced' ) == 'advanced' ) { ?>
