...
* [Pro] Search accessibility: Screen reader label and switch toggle to button, aria for toggles and search
* [Pro] Feature: Ability to replace search in dropdown with custom code or shortcodes
...
* [Pro] Enhancement: Consistent scrollTo on page reload
* [Pro] Enhancement: Close ScrollTo links immediately when setting is enabled
* Security Update
